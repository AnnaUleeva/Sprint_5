...
driver.find_element(By.XPATH, locators.main_screen_buns_tab).click()
time.sleep(1)
WebDriverWait(driver, 3).until(expected_conditions.visibility_of_element_located((By.XPATH, locators.main_screen_buns_title)))
